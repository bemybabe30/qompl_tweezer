...
position = "110cm"
input_data = r'/Users/kiseok_lee/Downloads/{}_2_gray.tif'.format(position)

x_hor = np.linspace(0, 1439, 1440)
x_ver = np.linspace(0, 1079, 1080)
...
guess_hor = [5000, 620, 210, 0, 0]
guess_ver = [7100, 520, -100, 0, 0]
